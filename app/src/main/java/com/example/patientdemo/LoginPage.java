...
//        });
    ...
    public void loginUser(View view){
        if(validateUsername() && validatePassword()){
            ...
            //authenticating user code below

            firebaseAuth.signInWithEmailAndPassword(UserName,PassWord).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        if (Client.equals("doctors")) {
                            // Redirect to the doctor homepage
                            startActivity(new Intent(getApplicationContext(), MainActivity.class));
                        } else {
                            // Redirect to the patients/students homepage
                            startActivity(new Intent(getApplicationContext(), PatientDashboard.class));
                        }
                        Toast.makeText(com.example.patientdemo.LoginPage.this, "Logged in successfully! ", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(com.example.patientdemo.LoginPage.this, "Error!" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()) {
                        ...
                        if (mobileNo != null) {
                            ...
                            Intent intent = new Intent(LoginPage.this, PatientDashboard.class);
                        ...
                        if (Client.equals("patients")) {
                            ...
                            intent = new Intent(LoginPage.this, PatientDashboard.class);
                        }
                        else
